...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 21 16:43:23 2024
...
image = cv2.imread("images/healthy3.jpg")
...
_, thresh = cv2.threshold(preprocessed_roi, 50, 255, cv2.THRESH_BINARY_INV)
...
#print(edged)
#thresh = cv2.threshold(edged, 55, 255, cv2.THRESH_BINARY)
